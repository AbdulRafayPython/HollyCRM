...
const PATHS = {
  ...
  hub: "M18 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM9 11a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM17 18a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM8.5 9.5l4-2M8.5 13l3.5 3M14.5 9l-.5 6",
  plug: "M12 2v6m4-6v6M9 8h6a3 3 0 0 1 3 3v2a6 6 0 0 1-6 6v3m-6-11a3 3 0 0 1 3-3m0 0v2m0 6a6 6 0 0 0 6 6",
  puzzle: "M19.5 12h-2.5a2 2 0 0 1-2-2 2 2 0 0 0-4 0 2 2 0 0 1-2 2H6.5A2.5 2.5 0 0 0 4 14.5v5A2.5 2.5 0 0 0 6.5 22h13a2.5 2.5 0 0 0 2.5-2.5v-5a2.5 2.5 0 0 0-2.5-2.5zM12 4.5A2.5 2.5 0 0 1 14.5 7h5A2.5 2.5 0 0 1 22 9.5v2.5h-2.5a2 2 0 0 0-2 2 2 2 0 0 1-4 0 2 2 0 0 0-2-2H9v-2.5A2.5 2.5 0 0 1 11.5 7h.5z",
  grid: "M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z",
  whatsapp: "M3 21l1.65-3.8a9 9 0 1 1 3.4 2.9L3 21zm6.5-12.5c-.2 0-.5.1-.7.4-.3.3-1 1-1 2.4s1 2.8 1.2 3c.1.2 2 3.1 4.9 4.3 2.4 1 2.9.7 3.4.6.5-.1 1.7-.7 1.9-1.4.2-.7.2-1.3.2-1.4 0-.2-.2-.3-.5-.4l-2.3-1.1c-.3-.1-.5-.1-.7.2l-1 1.2c-.2.2-.3.2-.6.1-.3-.1-1.3-.5-2.5-1.5-.9-.8-1.5-1.8-1.7-2.1-.2-.3 0-.5.1-.6l.5-.6c.2-.2.3-.4.4-.6.1-.2 0-.4 0-.6l-1-2.4c-.2-.6-.5-.6-.7-.6z",
  ...
  eye: "M2 12s3.6-7 10-7 10 7 10 7-3.6 7-10 7-10-7-10-7zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6",
  eyeOff:
    "m2 2 20 20M10.6 10.6a3 3 0 0 0 4.24 4.24M9.9 5.2A9.6 9.6 0 0 1 12 5c6.4 0 10 7 10 7a17.9 17.9 0 0 1-3.4 4.3M6.3 6.3A17.6 17.6 0 0 0 2 12s3.6 7 10 7a9.7 9.7 0 0 0 3.6-.7",
