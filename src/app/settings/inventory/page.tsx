  ...
  return (
    <div className="flex h-full flex-col bg-surface">
      <header className="flex h-16 shrink-0 items-center gap-3 border-b border-edge bg-card px-6">
        ...
        <h1 className="text-h1 text-ink">Hotel inventory</h1>
        <span className="text-meta text-muted">{hotels.length} hotels</span>
        <button
        ...
        <div className="mx-auto max-w-3xl space-y-4">
          {error && (
            <p className="flex items-start gap-2 rounded-lg border border-danger/25 bg-danger-soft p-3 text-meta text-danger-dark">
              <Icon name="alert" size={15} className="mt-px" />{error}
            </p>
          )}
          ...
          <p className="text-center text-caption text-subtle">
            The AI only offers hotels that are visible, priced for the requested dates, and have rooms left.
          </p>
        </div>
      </div>
